...
devtools::install_github(
  "statsmaths/smodels", force = TRUE, dependencies = FALSE, quiet = TRUE
)
devtools::install_github(
  "statsmaths/ggmaptile", force = TRUE, dependencies = FALSE, quiet = TRUE
)
devtools::install_github(
  "yutannihilation/ggsflabel", force = TRUE, dependencies = FALSE, quiet = TRUE
)
```
